export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxa65edb6f00e7af69",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0b5b63154df51a6e9f95ce40b722da8a",
  ...
  USERS: [
    {
      ...
      id: "o6DMI6iumW6ZEDf-FXPO53K5-EHc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "WcCzH4pY9fR_Nrhqowu2nACLsfnFmRQA2AYvG2KKa84",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "邯郸",
      ...
      openUrl: "https://v.kuaishou.com/sLLyLS",
  ...
  FESTIVALS: [
    ...
    {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {"type": "生日", "李静怡": "李静怡", "year": "2003", "date": "08-11", isShowAge: true},
    {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "09-01"},
    // 你可以不断按格式往下增加
    // ...
  ],
